  ...
  const pricingPackages = [
    {
      ...
      features: [
        ...
        "-", // ใส่ขีดไว้เพื่อเว้นวรรคให้บรรทัดเท่าเพื่อน (เทคนิคทำให้การ์ดเท่ากัน)
        "-",
        "-",
        "-",
      ],
    ...
    },
    {
      ...
      features: [
        ...
        "ลงประกาศฟรี 30 โพส",
        "ดันทุก 3 ชม. (Auto 5 โพส)", // รวมบรรทัด
        "เพิ่มบริการเสริมได้ครบทุกข้อ",
        "หน้าเว็บ + โดเมนส่วนตัว",
        "ระบบ Lead + ลงคอร์สได้ 10 คอร์ส",
        "แกลลอรี่ 20 รูป (เฉลี่ย 5 บ./วัน)", // จุดขาย
      ],
    },
  ];
